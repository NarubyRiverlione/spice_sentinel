...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to spiced "gobject list" output
    ...
    def spiced_serialise(self):
        import spicelib
        return spicelib.SHIM_serialise_for_spiced(self.serialise())
